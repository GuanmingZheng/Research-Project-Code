...
fitLME5 <- lme(sqrt(CD4) ~ CD4 + prevOI + drug + AZT + start + stop + event, random = ~ obstime | patient, data = aids)
...
##################################################fit7####################################################### with fit5
##linear mixed effects model Time~CD4^2 + prevOI + drug + AZT + start^2 + stop^2 + event
fitLME7 <- lme(sqrt(CD4) ~ CD4^2 + prevOI + drug + AZT + start^2 + stop^2 + event, random = ~ obstime | patient, data = aids)
